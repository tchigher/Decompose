...
import com.arkivanov.todo.app.ribs.interop.DecomposeRib
...
class RootRooter internal constructor(
    ...
    override fun resolve(routing: Routing<Configuration>): RoutingAction =
        when (routing.configuration) {
            is Configuration.Todo -> attach { DecomposeRib(todoRootBuilder, it) }
            is Configuration.Settings -> attach { DecomposeRib(counterRootBuilder, it) }
        }
}
